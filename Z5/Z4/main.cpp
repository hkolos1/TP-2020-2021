...
public:
  Automobil(int tezina, std::vector<int> tezine)
      : ApstraktnoVozilo(tezina), tezinePutnika(tezine) {
    int suma(0);
    for (int broj : tezine)
      suma += broj;
...
public:
  Kamion(int tezinaVozila, int tezinaTereta)
      : ApstraktnoVozilo(tezinaVozila), tezinaTereta(tezinaTereta) {}
...
void Kamion::IspisiPodatke() const {
  std::cout << "Vrsta vozila: Kamion" << std::endl
            << "Vlastita tezina: " << tezinaVozila << " kg" << std::endl
            << "Tezine tereta: " << tezinaTereta << " kg" << std::endl
...
public:
  Autobus(int tezinaVozila, int ukupanBrojPutnika, int prosjecnaTezinaPutnika)
      : ApstraktnoVozilo(tezinaVozila), ukupanBrojPutnika(ukupanBrojPutnika),
        prosjecnaTezinaPutnika(prosjecnaTezinaPutnika) {}
  int DajTezinu() const override { return tezinaVozila; }
  int DajUkupnuTezinu() const override {
    return tezinaVozila + (ukupanBrojPutnika * prosjecnaTezinaPutnika);
  }
...
void Autobus::IspisiPodatke() const {
  std::cout << "Vrsta vozila: Autobus" << std::endl
            ...
            << "Prosjecna tezina putnika: " << prosjecnaTezinaPutnika
            << std::endl
            << "Ukupna tezina: " << DajUkupnuTezinu() << " kg" << std::endl;
}
